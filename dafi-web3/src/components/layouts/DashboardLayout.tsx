...
const farmerNavigation: NavItem[] = [
  {
    name: 'Dashboard',
    href: '/dashboard',
    icon: (props) => (
...
const DashboardLayout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // TODO: Get user type from context or local storage
  const userType = 'investor'; // or 'farmer'
  const navigation = userType === 'farmer' ? farmerNavigation : investorNavigation;
  ...
  return (
    <div>
      <div className="min-h-full">
        {/* Mobile menu */}
        <div className={`fixed inset-0 flex z-40 md:hidden ${sidebarOpen ? 'visible' : 'invisible'}`}>
          ...
          <div className="relative flex-1 flex flex-col max-w-xs w-full bg-white">
            ...
            <div className="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
              <div className="flex-shrink-0 flex items-center px-4">
                <img className="h-8 w-auto" src="/logo.svg" alt="DAFI" />
              </div>
