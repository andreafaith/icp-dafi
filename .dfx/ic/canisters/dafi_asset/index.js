...
import { idlFactory } from './dafi_asset.did.js';
export { idlFactory } from './dafi_asset.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_DAFI_ASSET;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./dafi_asset.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the dafi_asset canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./dafi_asset.did.js")._SERVICE>}
 */
export const dafi_asset = createActor(canisterId);
