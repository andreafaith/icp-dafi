...
import { idlFactory } from './dafi_investment.did.js';
export { idlFactory } from './dafi_investment.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_DAFI_INVESTMENT;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./dafi_investment.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the dafi_investment canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./dafi_investment.did.js")._SERVICE>}
 */
export const dafi_investment = createActor(canisterId);
