...
import { idlFactory } from './dafi_kyc.did.js';
export { idlFactory } from './dafi_kyc.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_DAFI_KYC;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./dafi_kyc.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the dafi_kyc canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./dafi_kyc.did.js")._SERVICE>}
 */
export const dafi_kyc = createActor(canisterId);
